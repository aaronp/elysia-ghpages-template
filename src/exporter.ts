...
<html>
  <head>
    ...
    <!-- Pre-made dark theme for Swagger UI -->
    <link rel="stylesheet" href="https://unpkg.com/swagger-ui-themes@3.0.0/themes/3.x/theme-monokai.css" />
...
// Write external Swagger UI config (avoid inline parsing issues on Pages)
const swConfig = `
(function(){
  function toBase(){
